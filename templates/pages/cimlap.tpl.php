    ...
    <div class="row">
        <div class="col-5">
            <ul>
                ...
                <li> <span class="felkov">Lábazati kiemelés + szigetelés:</span> 1 sor 30 cm széles pincefalazó, 10 cm lábazati szigeteléssel</li>
                <li> <span class="felkov">Vasalt aljzat:</span> 10-12 cm C16-16KK helyszíni vagy transzport beton, 4,2/20/20 hálós vasalás</li>
                <li> <span class="felkov">Aljzat vízszigetelés:</span> GV4 bitumenes szigetelőlemez</li>
        ...
        <div class="col-5">
            <ul>
                ...
                <li><span class="felkov"> Bádogozás, csatorna:</span> Horganyzott lemez csatorna és vápa</li>
                <li><span class="felkov"> Külső nyílászárók:</span> Műanyag, bukó-nyíló fehér, U= 0.75 szigetelésű, 6 kamrás, 3 rétegű üvegezésű. A bejárati ajtó, biztonsági műanyag vagy faajtó (150 000 Ft összegben) </li>
                <li><span class="felkov"> Födém:</span> Láng- és gombamentesítéssel felületkezelt, függesztett fa födém gipszkarton borítással </li>
                <li><span class="felkov"> Válaszfalak:</span> Válaszfalak 10 cm-es Porotherm válaszfalazó téglából</li>
                <li><span class="felkov"> Alapszerelések:</span> Villamos, gépészet, alapszerelések védőcsőben, vezetékek, csövek elhelyezése szabványban előírt anyagokkal</li>
                <li><span class="felkov"> Fűtésrendszer készre szerelése:</span> Hagyományos gázkazános padlófűtés (radiátoros fűtés) rendszer. A vízvezetékrendszer unipress 5 rétegű csővezetékkel, a szennyvízcsatornázás KG-PVC csővel szerelten kerül kiépítésre. A WC tartályos megoldású, 1 db fali csatlakozó a mosógépnek.</li>
            </ul>
        </div>
    </div>
</div>
